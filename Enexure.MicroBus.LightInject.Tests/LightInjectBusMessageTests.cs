...
{
	public class LightInjectBusMessageTests
	{
		[Fact]
		public async Task FullSystemTest()
		{
			...
			var busBuilder = new BusBuilder()
				...
				.RegisterHandlers(x => x.FullName.Contains("LightInjectBusMessageTests"), assembly);

			containerBuilder.RegisterMicroBus(busBuilder);

			var mediator = containerBuilder.GetInstance<IMicroMediator>();
